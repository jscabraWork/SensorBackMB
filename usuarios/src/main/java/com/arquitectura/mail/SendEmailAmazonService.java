	...
	public void mandarCorreoContrasenia(String to, String idEncriptado) throws Exception {
		...
		String BODY = String.join(
				...
				"<!DOCTYPE html>\r\n"
						...
						+ "    <p class=\"footer\">Cualquier duda que tengas, por favor comunícate con nosotros<br><a target=\"_blank\" href=\"https://api.whatsapp.com/send?phone=573219187944&text=Hola%20Sensor%20Events,%20me%20comunico%20porque:\">+57 321 918 7944</a>.</p>\r\n"
						+ "</div>\r\n"
						+ "</body>\r\n"
						+ "</html>\r\n"
		);
	...
	public void mandarCorreoUsuario(String usuario, String idEncriptado, String to) throws Exception {
		...
		String BODY = String.join(
				...
				"<!DOCTYPE html>\r\n"
						...
						+ "        <a href=\"https://api.whatsapp.com/send?phone=573219187944\" target=\"_blank\">\r\n"
