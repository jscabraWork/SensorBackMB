...
public class UsuarioController extends CommonControllerString<Usuario, UsuarioService>{
	...
	@PreAuthorize("hasRole('ADMIN')")
        ...
        // ENDPOINTS PARA LOGIN CON PROVIDER
        ...
        public Usuario getUsuarioByProviderId(@PathVariable String providerId, @PathVariable int tipoProvider) {
            return service.getUsuarioByProviderId(providerId, tipoProvider);
        }
        ...
        public ResponseEntity<?> registroConProvider(@RequestBody Usuario pCliente,
            ...
            try {
                Usuario usuario = service.crearClienteConProvider(pCliente, tipoProvider, providerId, accessToken, refreshToken);
        ...
        public ResponseEntity<?> asociarProviderAUsuarioExistente(@RequestParam String correo,
            ...
            try {
                ...
                // Asociar proveedor al usuario existente
                service.asociarProviderAUsuarioExistente(usuarioExistente, tipoProvider, providerId, accessToken);

                response.put("mensaje", "Tu cuenta se ha asociadoo exitosamente");
