...
public class ClienteServiceConsumerImpl implements ClienteServiceConsumer{
    ...
    @Autowired
    private UsuarioEventAdapter adapter;

    /**
     * Metdo que maneja los eventos provenientes de Kafka. Este metodo procesa los eventos de tipo
     * {@link UsuarioEvent} y {@link EntityDeleteEventLong}.
     *
     * @param baseEvent El evento base recibido desde Kafka.
     * @param messageId El ID único del mensaje recibido desde Kafka.
     * @param messageKey La clave del mensaje recibido desde Kafka.
     * @throws NotRetryableException Si el tipo de evento no es soportado o ocurre un error.
     */
    @Override
