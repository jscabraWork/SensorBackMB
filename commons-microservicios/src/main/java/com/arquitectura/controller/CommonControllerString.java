 ...
 * para una entidad genérica E. Utiliza un servicio genérico S que extiende CommonServiceString<E>.
 *
 * @param <E> El tipo de la entidad genérica
 * @param <S> El tipo del servicio genérico que extiende CommonServiceString<E>
 */
public class CommonControllerString<E, S extends CommonServiceString<E>> {
	...
	/**
	 * Devuelve una entidad E por su ID (String)
	 * @param pId El ID de la entidad (String)
	 ...
	 */
	@GetMapping("/{pId}")
	public ResponseEntity<?> verPorId(@PathVariable String pId) {
	...
	/**
	 * Elimina una entidad E por su ID (String)
	 * @param pId El ID de la entidad a eliminar (String)
	 * @return ResponseEntity con el código de estado 204 (No Content)
	 */
	@DeleteMapping("/{pId}")
	public ResponseEntity<?> borrar(@PathVariable String pId) {
