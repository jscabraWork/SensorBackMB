...
public class TicketServiceImpl extends CommonServiceImpl<Ticket, TicketRepository> implements TicketService {
    ...
    @Override
    public List<Ticket> findByEventoIdAndPuntoNumeroDocumentoAndEstado(
            Long eventoId, 
            String promotorNumeroDocumento, 
            Integer estado) {
        return repository.findByLocalidad_Dias_Evento_IdAndPuntofisico_NumeroDocumentoAndEstado(
                eventoId, 
