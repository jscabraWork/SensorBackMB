...
import com.arquitectura.localidad.consumer.LocalidadServiceImpl;
...
class LocalidadConsumerTest {
    ...
    void consumeLocalidadEvent_persistsEntity_andRegistersMessage() {
        ...
        nuevaLocalidad.setEstado(evt.getEstado());
    ...
    void consumeLocalidadEvent_updatesExistingEntity_andRegistersMessage() {
        ...
        localidadExistente.setEstado(1);
        ...
        localidadActualizada.setEstado(evt.getEstado());
