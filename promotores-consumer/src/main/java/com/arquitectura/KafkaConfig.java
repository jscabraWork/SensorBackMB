...
public class KafkaConfig {
    ...
    ConsumerFactory<String, Object> consumerFactory() {
        ...
        config.put(ConsumerConfig.ISOLATION_LEVEL_CONFIG, enviroment.getProperty("spring.kafka.consumer.isolation-level", "read_committed").toLowerCase());
    ...
    ProducerFactory<String, Object> producerFactory() {
        Map<String, Object> config = new HashMap<>();
        config.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, enviroment.getProperty("spring.kafka.producer.bootstrap-servers"));
